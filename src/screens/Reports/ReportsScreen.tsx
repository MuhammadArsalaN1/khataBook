...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 24, fontWeight: '700', color: COLORS.text, paddingTop: 16, marginBottom: 14 },
  ...
  periodText: { fontSize: 12, color: COLORS.textLight, fontWeight: '700' },
  ...
  typeLabel: { fontSize: 13, color: COLORS.textLight, fontWeight: '500' },
  typeRight: { flexDirection: 'row', gap: 10, alignItems: 'center' },
  typeAmount: { fontSize: 14, fontWeight: '700', color: COLORS.text },
  typePct: { fontSize: 11, color: COLORS.textLight, width: 36, textAlign: 'right', fontWeight: '600' },
  entryCount: { fontSize: 11, color: COLORS.textLight, marginTop: 8, textAlign: 'right', fontWeight: '600' },
  catRow: {
    flexDirection: 'row',
    alignItems: 'center',
    paddingVertical: 10,
  ...
  rank: { fontSize: 13, color: COLORS.primary, width: 24, fontWeight: '700' },
  ...
  entryLeft: {},
  entryCategory: { fontSize: 13, fontWeight: '700', color: COLORS.text },
  entryMeta: { fontSize: 11, color: COLORS.textLight, marginTop: 2, fontWeight: '500' },
  ...
  csvBtn: { backgroundColor: COLORS.card, borderWidth: 1, borderColor: COLORS.success },
