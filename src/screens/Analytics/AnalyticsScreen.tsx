...
const styles = StyleSheet.create({
  ...
  title: { fontSize: responsiveFontSize(24), fontWeight: '700', color: COLORS.text, paddingTop: 16, marginBottom: 16 },
  card: { backgroundColor: COLORS.card, borderRadius: 14, padding: responsiveSpacing(16), marginBottom: 14, shadowColor: '#000', shadowOpacity: 0.05, shadowRadius: 8, elevation: 1, borderWidth: 0 },
  cardTitle: { fontSize: responsiveFontSize(15), fontWeight: '700', color: COLORS.text, marginBottom: 14 },
  cardHeaderRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 14 },
  periodRow: { flexDirection: 'row', gap: 6 },
  periodBtn: { paddingHorizontal: 10, paddingVertical: 6, borderRadius: 8, borderWidth: 0, backgroundColor: COLORS.cardSecondary },
  periodBtnActive: { backgroundColor: COLORS.primary },
  periodText: { fontSize: 11, color: COLORS.textLight, fontWeight: '700' },
  periodTextActive: { color: COLORS.white, fontWeight: '700' },
  insightGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 10 },
  insightItem: { flex: 1, minWidth: '45%', backgroundColor: COLORS.cardSecondary, borderRadius: 12, padding: 14, alignItems: 'center' },
  insightEmoji: { fontSize: 24, marginBottom: 6 },
  insightLabel: { fontSize: 12, color: COLORS.textLight, marginBottom: 3, fontWeight: '600' },
  insightVal: { fontSize: 15, fontWeight: '700', color: COLORS.text, textAlign: 'center' },
  compTable: { marginTop: 12, borderTopWidth: 1, borderTopColor: COLORS.divider, paddingTop: 8 },
  compRow: { flexDirection: 'row', alignItems: 'center', paddingVertical: 8 },
  compLabel: { flex: 1, fontSize: 13, color: COLORS.textLight, fontWeight: '500' },
  compTotal: { fontSize: 13, fontWeight: '700', color: COLORS.text, width: 100, textAlign: 'right' },
  compChange: { fontSize: 12, fontWeight: '700', width: 60, textAlign: 'right' },
  filterRow: { flexDirection: 'row', gap: 8, flexWrap: 'wrap', marginBottom: 12 },
  filterChip: { paddingHorizontal: 12, paddingVertical: 6, borderRadius: 8, borderWidth: 0, backgroundColor: COLORS.cardSecondary },
  filterChipActive: { backgroundColor: COLORS.primary },
  filterText: { fontSize: 12, color: COLORS.textLight, fontWeight: '600' },
  filterTextActive: { color: COLORS.white, fontWeight: '700' },
  trendRow: { flexDirection: 'row', justifyContent: 'space-between', paddingVertical: 12 },
  trendRowBorder: { borderBottomWidth: 1, borderBottomColor: COLORS.divider },
  trendCategory: { fontSize: responsiveFontSize(14), fontWeight: '700', color: COLORS.text },
  trendAmount: { fontSize: responsiveFontSize(12), color: COLORS.textLight, marginTop: 2, fontWeight: '500' },
  trendChange: { fontSize: responsiveFontSize(13), fontWeight: '700' },
  trendCompare: { fontSize: responsiveFontSize(11), color: COLORS.textLight, marginTop: 2, fontWeight: '500' },
  patternRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingVertical: 12 },
  patternRowBorder: { borderBottomWidth: 1, borderBottomColor: COLORS.divider },
  patternCategory: { fontSize: responsiveFontSize(14), fontWeight: '700', color: COLORS.text },
  patternFreq: { fontSize: responsiveFontSize(12), color: COLORS.textLight, marginTop: 2, fontWeight: '500' },
  patternAmount: { fontSize: responsiveFontSize(14), fontWeight: '700', color: COLORS.text },
});
