...
const styles = StyleSheet.create({
  ...
  chip: { width: 38, height: 28, borderRadius: 6, backgroundColor: COLORS.accent },
  ...
  cardIconBubble: { width: 46, height: 46, borderRadius: 14, backgroundColor: 'rgba(245,183,0,0.22)', alignItems: 'center', justifyContent: 'center' },
  cardProvider: { color: '#fff', fontSize: responsiveFontSize(16), fontWeight: '800' },
  cardSub: { color: 'rgba(255,255,255,0.75)', fontSize: responsiveFontSize(11), fontWeight: '500', marginTop: 1 },
  cardPKR: { color: COLORS.accent, fontSize: responsiveFontSize(13), fontWeight: '800' },
  innerPanel: { backgroundColor: '#fff', borderRadius: 16, padding: 12 },
  noBalance: { fontSize: responsiveFontSize(12), color: '#9C9C95', fontWeight: '500', textAlign: 'center', paddingVertical: 8 },
  ...
  balRow: { flexDirection: 'row', alignItems: 'center', gap: 10, paddingVertical: 7, borderBottomWidth: 1, borderBottomColor: '#F5F5F0' },
  balFlag: { fontSize: 18 },
  balCur: { fontSize: responsiveFontSize(12), fontWeight: '800', color: '#52525B', width: 38 },
  balAmt: { flex: 1, textAlign: 'right', fontSize: responsiveFontSize(14), fontWeight: '800', color: '#1A1A1A' },
  addBtn: { marginTop: 8, paddingVertical: 10, borderRadius: 10, backgroundColor: '#F5F5F0', alignItems: 'center' },
  ...
  modalSheet: { backgroundColor: '#FAFAF7', borderTopLeftRadius: 28, borderTopRightRadius: 28, paddingTop: 10, maxHeight: '92%' },
  modalHandle: { width: 40, height: 4, borderRadius: 2, backgroundColor: '#ECECE6', alignSelf: 'center', marginBottom: 12 },
  ...
  modalTitle: { fontSize: responsiveFontSize(17), fontWeight: '800', color: '#1A1A1A' },
  pickerLabel: { fontSize: responsiveFontSize(12), fontWeight: '700', color: '#52525B', paddingHorizontal: 20, marginBottom: 8 },
